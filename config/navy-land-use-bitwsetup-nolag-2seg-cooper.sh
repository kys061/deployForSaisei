...
/opt/stm/target/c.sh POST epms/epm/policies/ name ALL-L3 rate 95000 host_eq true
/opt/stm/target/c.sh POST epms/epm/policies/ name ALL-L2 rate 10000 ass true

/opt/stm/target/c.sh POST epms/ name epmphy
/opt/stm/target/c.sh POST epms/epmphy/policies/ name ALL-L3 rate 95000 host_eq true
/opt/stm/target/c.sh POST epms/epmphy/policies/ name ALL-L2 rate 10000 ass true
...
/opt/stm/target/c.sh POST epms/epm/policies/ name VIPUSERS rate 20000 mult 1 assured 1 host_eq 0
/opt/stm/target/c.sh POST epms/epmphy/policies/ name VIPUSERS rate 20000 mult 1 assured 1 host_eq 0
...
/opt/stm/target/c.sh POST epms/epm/policies/ name KEYAPPS rate 20000 mult 1 assured 1 host_eq 0
/opt/stm/target/c.sh POST epms/epmphy/policies/ name KEYAPPS rate 20000 mult 1 assured 1 host_eq 0
