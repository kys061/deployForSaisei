...
/opt/stm/target/c.sh POST interfaces/ name stm5.100 type vlan egress_policy_map epm rate 1000000
/opt/stm/target/c.sh POST interfaces/ name stm6.100 type vlan egress_policy_map epm rate 1000000 internal true
/opt/stm/target/c.sh PUT interfaces/stm5.100 ingress_policy_map ipm
/opt/stm/target/c.sh PUT interfaces/stm6.100 ingress_policy_map ipm
/opt/stm/target/c.sh PUT interfaces/stm5.100 peer stm6.100

/opt/stm/target/c.sh POST interfaces/ name stm7.100 type vlan egress_policy_map epm rate 1000000
/opt/stm/target/c.sh POST interfaces/ name stm8.100 type vlan egress_policy_map epm rate 1000000 internal true
/opt/stm/target/c.sh PUT interfaces/stm7.100 ingress_policy_map ipm
/opt/stm/target/c.sh PUT interfaces/stm8.100 ingress_policy_map ipm
/opt/stm/target/c.sh PUT interfaces/stm7.100 peer stm8.100
## Now create the Interfaces, link to the policy maps and enable
...
/opt/stm/target/c.sh PUT interfaces/stm5.100 state enabled
/opt/stm/target/c.sh PUT interfaces/stm6.100 state enabled
/opt/stm/target/c.sh PUT interfaces/stm7.100 state enabled
/opt/stm/target/c.sh PUT interfaces/stm8.100 state enabled
