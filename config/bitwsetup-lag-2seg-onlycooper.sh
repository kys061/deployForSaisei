...
/opt/stm/target/c.sh POST interfaces/ name ethseg1-ext type eth egress_policy_map epmphy rate 1000000 lag_interface aggint-ext system_interface stm1
/opt/stm/target/c.sh POST interfaces/ name ethseg1-int type eth egress_policy_map epmphy rate 1000000 lag_interface aggint-int system_interface stm2 internal true
...
/opt/stm/target/c.sh POST interfaces/ name ethseg2-ext type eth egress_policy_map epmphy rate 1000000 lag_interface aggint-ext system_interface stm3
/opt/stm/target/c.sh POST interfaces/ name ethseg2-int type eth egress_policy_map epmphy rate 1000000 lag_interface aggint-int system_interface stm4 internal true
