...
/opt/stm/target/c.sh POST interfaces/ name ethseg1-ext type eth egress_policy_map epmphy rate 1000000 system_interface stm5
/opt/stm/target/c.sh POST interfaces/ name ethseg1-int type eth egress_policy_map epmphy rate 1000000 system_interface stm6 internal true
...
/opt/stm/target/c.sh POST interfaces/ name ethseg2-ext type eth egress_policy_map epmphy rate 1000000 system_interface stm7
/opt/stm/target/c.sh POST interfaces/ name ethseg2-int type eth egress_policy_map epmphy rate 1000000 system_interface stm8 internal true
